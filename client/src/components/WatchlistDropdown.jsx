...
export default function WatchlistDropdown() {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-[22rem] max-h-[28rem] overflow-y-auto glass-premium rounded-3xl z-50 origin-top-right animate-fadeUp">
          <div className="p-3">
            <div className="flex items-center justify-between mb-3 px-2 pt-1">
              <h3 className="text-xs font-bold text-slate-400 uppercase tracking-widest">
                Your Watchlist
              </h3>
              <span className="text-xs font-extrabold text-teal-600 dark:text-teal-400 bg-teal-500/10 px-2.5 py-0.5 rounded-full">
                {items.length} Series
              </span>
            </div>
